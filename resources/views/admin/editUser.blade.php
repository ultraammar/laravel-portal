...
@section('content')
                            ...
                            <div class="card">
                                ...
                                <!-- <div class="card-content"> -->
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="review">
                                            <h6>Business Review</h6>
                                            <p>Data is not comming right now </p>
                                        </div>
                                        ...
                                        <div class="change">
                                                ...
                                                <div class="tab1">
                                                    <ul> 
                                                        <li id="user_1"><p><strong>LEARING INFO</strong> <p></li>
                                                        <li id="user_1"><label for="emailAddress">DATE</label><br><span>00/00/00</span></li>
                                                        <li id="user_1"><label for="dob">MADE BY</label><br><span>numanarif580@gmail.com</span></li>
                                                        <li id="user_spnote" class="spnote"><label for="startDate">NOTE</label><br><span></span></li>
                                                    </ul>
                                                </div>
                                            </div>
                                    </div>
 ...
 select{
    ...
    .change #user_right_li{
        list-style:none;
        float:left;
        width:20%;
    }
    .change p{ font-size:12px;}
    .change ul{
        width:100%;
        height:100px;
    }
